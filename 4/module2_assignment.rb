...
class Solution
  ...
  def print_highest_word_frequency_across_lines()
    @analyzed.each do |item|
      puts "#{item.highest_wf_words} (appears in line #{item.line_number})" if @highest_count_across_lines == item.highest_wf_count
    end
  end
end
